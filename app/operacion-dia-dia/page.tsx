...
export default function OperacionDiaDia() {
    ...
    <div className="main-wrapper">
        ...
        <div style={{ position: 'absolute', top: '12px', left: '0', right: '0', display: 'flex', justifyContent: 'center', pointerEvents: 'none', zIndex: 999999 }}>
          <div style={{ pointerEvents: 'auto', padding: '8px 12px' }}>
            <div className="card" style={{ display: 'flex', gap: '14px', marginBottom: '0', padding: '10px 12px', alignItems: 'center', justifyContent: 'space-between' }}>
              <h1 style={{ marginBottom: '0', fontSize: '20px', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>⏱️ Operación Día a Día</h1>
              ...
              <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <small style={{ color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', fontSize: '10px' }}>Vuelos Activos</small>
                  <div style={{ fontSize: '14px', fontWeight: 700, color: 'var(--accent-blue)', textShadow: '0 0 10px rgba(37, 100, 235, 0.3)', marginTop: '2px' }}>5</div>
                </div>
                <div style={{ minWidth: 0 }}>
                  <small style={{ color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', fontSize: '10px' }}>Maletas en Tránsito</small>
                  <div style={{ fontSize: '14px', fontWeight: 700, color: 'var(--accent-blue)', textShadow: '0 0 10px rgba(37, 100, 235, 0.3)', marginTop: '2px' }}>234</div>
                </div>
              </div>
              <style>{`
                @keyframes blink {
      ...
      <div id="statsSection" style={{ paddingTop: '40px', paddingBottom: '40px', backgroundColor: 'white' }}>
        <div className="container">
          <h2 style={{ fontSize: '24px', fontWeight: 700, marginBottom: '24px', color: 'var(--text-primary)' }}>📊 Estadísticas en Vivo</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '12px' }}>
            <div className="stat-card" style={{ display: 'flex', flexDirection: 'column', padding: '12px' }}>
              <h3 style={{ fontSize: '13px', margin: '0 0 8px 0' }}>Vuelos Operando</h3>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: 'var(--accent-blue)' }}>5</div>
              </div>
            </div>
            ...
            <div className="stat-card" style={{ display: 'flex', flexDirection: 'column', padding: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: 'var(--accent-blue)' }}>234</div>
              </div>
            </div>

            <div className="stat-card" style={{ display: 'flex', flexDirection: 'column', padding: '12px' }}>
              <h3 style={{ fontSize: '13px', margin: '0 0 8px 0' }}>Almacenes con Carga</h3>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: '#f97316' }}>8</div>
              </div>
            </div>

            <div className="stat-card" style={{ display: 'flex', flexDirection: 'column', padding: '12px' }}>
              <h3 style={{ fontSize: '13px', margin: '0 0 8px 0' }}>Entregas Exitosas (hoy)</h3>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: '#22c55e' }}>156</div>
              </div>
            </div>
          </div>
            ...
            <div className="card">
              ...
              <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#22c55e', flexShrink: 0 }}></span>
                  <span style={{ fontSize: '14px', color: 'var(--text-primary)' }}>Operación iniciada: Monitoreo en tiempo real</span>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div style={{ padding: '12px', backgroundColor: 'var(--bg-tertiary)', borderRadius: '6px' }}>
                  ...
                  <div style={{ fontSize: '24px', fontWeight: 700, color: '#22c55e', marginTop: '8px' }}>98.3%</div>
